...
import type { CallResponseConfig } from "./call-responder.js";
 ...
 * ```
 */
export async function setupDirectCallHandlers(_config: DirectCallIntegrationConfig): Promise<void> {
...
export async function initiateOutgoingCall(
  userId: string,
  channelId: string,
  _callManager: DiscordCallManager,
  _config: DirectCallIntegrationConfig,
): Promise<void> {
...
export async function setupDirectCallsWithCustomAgent(): Promise<void> {
  ...
  const _generateAgentResponse = async (_userId: string, input: string): Promise<string> => {
 ...
 * ```
 */
export async function endCall(userId: string, _callManager: DiscordCallManager): Promise<void> {
 ...
 * ```
 */
export async function getCallStats(userId: string, _callManager: DiscordCallManager): Promise<void> {
