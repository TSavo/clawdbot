...
export const WHISPER_SYSTEM_PRESET: SystemDeploymentConfig = {
  ...
  brewFormula: "whisper",
  searchPaths: ["/usr/local/bin", "/opt/whisper/bin", "~/.local/bin"],
...
export const ELEVENLABS_CLOUD_PRESET: CloudDeploymentConfig = {
  ...
  availableVoices: ["bella", "rachel", "daniel", "sam", "jessica"],
  cache: {
    enabled: true,
    ttlSeconds: 3600,
    maxEntries: 1000,
...
export const GOOGLE_TTS_CLOUD_PRESET: CloudDeploymentConfig = {
  ...
  availableVoices: ["en-US-Neural2-A", "en-US-Neural2-C", "en-US-Neural2-E"],
  quota: {
    enabled: true,
...
export const AZURE_TTS_CLOUD_PRESET: CloudDeploymentConfig = {
  ...
  availableVoices: ["en-US-AriaNeural", "en-US-GuyNeural", "en-GB-LibbyNeural"],
  regions: {
    default: "eastus",
    endpoints: {
