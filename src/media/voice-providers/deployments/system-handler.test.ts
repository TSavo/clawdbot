...
describe("SystemHandler", () => {
  ...
  describe("installKokoro", () => {
    it("should install kokoro successfully", async () => {
      ...
      await expect(handler.installKokoro("python3")).resolves.not.toThrow();
    });
    ...
    it("should use custom install command if provided", async () => {
      ...
      await expect(handler.installKokoro("python3", customCmd)).resolves.not.toThrow();
    ...
    it("should throw on install failure", async () => {
      ...
      await expect(handler.installKokoro("python3")).rejects.toThrow(VoiceProviderError);
    });
  });
  ...
  describe("stopProcess", () => {
    it("should stop process gracefully with SIGTERM", async () => {
      ...
      await expect(handler.stopProcess(12345, 1000)).resolves.not.toThrow();
    ...
    it("should force kill if graceful shutdown times out", async () => {
      ...
      await expect(handler.stopProcess(12345, 50)).resolves.not.toThrow();
  ...
  describe("startProcess", () => {
    it("should detect python and start process", async () => {
      ...
      mockSpawn.mockImplementationOnce((_cmd: string, _args: any[]) => {
