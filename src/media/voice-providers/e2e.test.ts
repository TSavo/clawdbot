...
import {
  ...
  type VoiceParticipantConfig,
} from "../voice-channels/channel.js";
...
describe("7. Performance Validation", () => {
  ...
  it("should achieve TTS latency <500ms for other providers", async () => {
    const providers = [
      ...
      new MockVoiceProvider("elevenlabs-tts", "elevenlabs", {
        capabilities: { estimatedLatencyMs: 300 },
      }),
      new MockVoiceProvider("chatterbox-tts", "chatterbox", {
        capabilities: { estimatedLatencyMs: 450 },
      }),
    ];
