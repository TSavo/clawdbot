...
describe("Voice Providers Docker E2E Integration", () => {
  ...
  const TEST_TEXT =
    "Hello, this is a test of clawdbot voice providers. Audio synthesis is working perfectly.";
  ...
  describe("Round-Trip TTS→STT Integration", () => {
    it(
      "should synthesize text and transcribe back with reasonable accuracy",
      { timeout: 90000 },
      async () => {
    ...
    it("should handle real audio through complete pipeline", { timeout: 90000 }, async () => {
      ...
      // Test various inputs
      const testCases = ["The quick brown fox", "Audio synthesis test", "Voice providers working"];
