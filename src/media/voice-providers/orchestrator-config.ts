...
export const DefaultPreferencesSchema = z.object({
  ...
  sttPreference: z.enum(["fast", "accurate", "cheap", "balanced"]).default("balanced"),

  /** Default TTS provider preference */
  ttsPreference: z.enum(["fast", "accurate", "natural", "balanced"]).default("balanced"),
...
export const OrchestratorConfigSchema = z.object({
  ...
  deploymentMode: z.enum(["docker", "system", "cloud", "hybrid"]).default("hybrid"),
...
export const OrchestratorRuntimeOptionsSchema = z.object({
  ...
  providerPreference: z.enum(["fast", "accurate", "cheap", "balanced"]).optional(),
...
export type OrchestratorRuntimeOptions = z.infer<typeof OrchestratorRuntimeOptionsSchema>;
 ...
 */
export async function validateOrchestratorConfig(config: unknown): Promise<OrchestratorConfig> {
