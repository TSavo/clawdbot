...
describe("ChatterboxExecutor", () => {
  ...
  describe("Synthesis", () => {
    ...
    it("should handle synthesis errors gracefully", async () => {
      ...
      await expect(executor.synthesize("Hello")).rejects.toThrow("Synthesis failed");
    });
  });
  ...
  describe("Transcription (Not Supported)", () => {
    ...
    it("should throw error for transcribe", async () => {
      ...
      await expect(executor.transcribe(dummyAudio)).rejects.toThrow("transcription not supported");
    });
