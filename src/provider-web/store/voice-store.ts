...
export interface VoiceStore {
  ...
  // eslint-disable-next-line typescript-eslint/no-redundant-type-constituents
  config: Partial<ApiVoiceConfig> | null;
  // eslint-disable-next-line typescript-eslint/no-redundant-type-constituents
  healthStatus: Record<string, Partial<ApiProviderStatus>>;
 ...
 */
export const getActiveSTTProvider = (
  store: VoiceStore,
  // eslint-disable-next-line typescript-eslint/no-redundant-type-constituents
): ApiVoiceProvider | undefined => {
 ...
 */
export const getActiveTTSProvider = (
  store: VoiceStore,
  // eslint-disable-next-line typescript-eslint/no-redundant-type-constituents
): ApiVoiceProvider | undefined => {
...
export const getProviderHealth = (
  ...
  providerId: string,
  // eslint-disable-next-line typescript-eslint/no-redundant-type-constituents
): Partial<ApiProviderStatus> | undefined => {
