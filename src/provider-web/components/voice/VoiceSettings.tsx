  ...
  return (
    <div className="voice-settings">
      ...
      <div className="settings-actions">
        <button className="button save-button" onClick={handleSave} disabled={loading}>
          {loading ? "Saving..." : "Save Settings"}
        </button>

        <button className="button reset-button" onClick={handleReset} disabled={loading}>
          Reset to Defaults
        </button>
      </div>
      ...
      <div className="settings-section info-section">
        ...
        <p>
          Voice providers enable speech-to-text (STT) and text-to-speech (TTS) capabilities. The
          system monitors their health continuously and can automatically switch to fallback
