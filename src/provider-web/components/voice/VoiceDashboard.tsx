...
export const VoiceDashboard: React.FC = () => {
  ...
  const [_testingProvider, setTestingProvider] = useState<string | null>(null);
    ...
    <div className="voice-dashboard">
      ...
      <header className="dashboard-header">
        <div className="header-content">
          ...
          <p className="header-subtitle">Manage and monitor your STT and TTS providers</p>
        </div>
      ...
      <footer className="dashboard-footer">
        ...
        <p className="footer-meta">Last Updated: {new Date().toLocaleTimeString()}</p>
      </footer>
    </div>
  );
};
