    ...
    <div className="stt-test-tab">
      <div className="test-section">
        ...
        >
          ...
          <input type="file" accept="audio/*" onChange={handleFileInput} className="file-input" />
        </div>
      ...
      <div className="test-section">
        ...
        <div className="setting-group">
          ...
          <select className="setting-select" disabled>
            <option>{providers.find((p) => p.id === activeSTT)?.name || "Select Provider"}</option>
          </select>
        </div>
    ...
    <div className="tts-test-tab">
      <div className="test-section">
        ...
        <textarea
          ...
          maxLength={1000}
        />
        <div className="character-count">{text.length} / 1000 characters</div>
      </div>
      ...
      <div className="test-section">
        ...
        <div className="setting-group">
          <label>Provider:</label>
          <select className="setting-select" disabled>
            <option>{activeTTSProvider?.name || "Select Provider"}</option>
          </select>
        </div>
