 ...
 */
export function generateConversationId(chatId: number, userId?: number, threadId?: number): string {
  if (threadId) {
...
export class VoiceConversationManager {
   ...
   */
  addVoiceMessage(metadata: VoiceMessageMetadata, transcription?: string): Conversation {
