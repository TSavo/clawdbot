...
import { synthesizeTextToVoice } from "./response-handler.js";
...
describe("SignalVoiceResponseHandler", () => {
  ...
  describe("synthesizeTextToVoice", () => {
    ...
    it("should reject empty text", async () => {
      ...
      await expect(synthesizeTextToVoice("", config, mockTtsExecutor)).rejects.toThrow(
    ...
    it("should reject text exceeding max length", async () => {
      ...
      await expect(synthesizeTextToVoice(longText, config, mockTtsExecutor)).rejects.toThrow(
  ...
  describe("Error handling", () => {
    it("should handle TTS provider errors", async () => {
      ...
      await expect(synthesizeTextToVoice(text, config, errorExecutor)).rejects.toThrow(
        "TTS provider error",
      );
    });
