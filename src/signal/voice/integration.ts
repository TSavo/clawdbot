...
import { isVoiceMessage, processVoiceMessage, extractVoiceMetadata } from "./message-handler.js";
 ...
 */
export function mergeSignalVoiceConfig(config: Partial<SignalVoiceConfig> = {}): SignalVoiceConfig {
  return {
