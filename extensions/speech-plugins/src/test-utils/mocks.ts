...
import type { TTSProvider, TTSCapabilities, TTSVoice } from "../interfaces/tts-provider.js";

/**
 * Create a mock STT provider for testing
 */
export function createMockSTTProvider(id: string = "mock-stt"): STTProvider {
 ...
 */
export function createMockTTSProvider(id: string = "mock-tts"): TTSProvider {
 ...
 */
export function createMockAudioBuffer(durationMs: number = 1000, sampleRate: number = 16000): Buffer {
 ...
 */
export function createMockWAVFile(durationMs: number = 1000, sampleRate: number = 16000): Buffer {
 ...
 */
export function createMockStream(data: Buffer): NodeJS.ReadableStream {
 ...
 */
export function createErrorSTTProvider(id: string, errorMessage: string): STTProvider {
 ...
 */
export function createErrorTTSProvider(id: string, errorMessage: string): TTSProvider {
