 ...
 */
export declare const WHISPER_SYSTEM_PLUGIN = "whisper-system";
/**
 ...
 * Sample Rates: 16000 Hz recommended
 */
export declare const FASTER_WHISPER_DOCKER_PLUGIN = "faster-whisper-docker";
/**
 ...
 */
export declare const DEEPGRAM_CLOUD_PLUGIN = "deepgram-cloud";
/**
 ...
 */
export declare const KOKORO_SYSTEM_PLUGIN = "kokoro-system";
/**
 ...
 */
export declare const CARTESIA_CLOUD_PLUGIN = "cartesia-cloud";
/**
 ...
 */
export declare const ELEVENLABS_CLOUD_PLUGIN = "elevenlabs-cloud";
/**
 ...
 */
export declare const CHATTERBOX_DOCKER_PLUGIN = "chatterbox-docker";
/**
 * Get all available provider plugin identifiers
 */
export declare function getAllProviderPlugins(): string[];
/**
 * Get STT provider plugin identifiers
 */
export declare function getSTTProviderPlugins(): string[];
/**
 * Get TTS provider plugin identifiers
 */
export declare function getTTSProviderPlugins(): string[];
